...
import cn.dev.service.UserService;
...
public class UserController {
    ...
    @ApiImplicitParam(name = "login", value = "用户详细实体user", required = true, dataType = "cn.gov.UserInfo")
    ...
    @ApiImplicitParam(name = "createuser", value = "用户详细实体user", required = true, dataType = "cn.gov.UserInfo")
    ...
    @ApiImplicitParam(name = "updateuser", value = "用户详细实体user", required = true, dataType = "cn.gov.UserInfo")
